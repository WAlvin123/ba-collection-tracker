  ...
  return (
    <div>
      ...
      <div>
        <button
          onClick={(event) => {
            handleFilterByDmg(event.target.textContent)
        ...
        >Sonic</button>
        <button
          className={buttonStates.b11State ? 'school-filter-button-clicked' : 'school-filter-button-unclicked'}
          onClick={() => {
            handlePulled()
        ...
        >Owned</button>
        <button
          className={buttonStates.b16State ? 'school-filter-button-clicked' : 'school-filter-button-unclicked'}
          onClick={() => {
            handleNotPulled()
